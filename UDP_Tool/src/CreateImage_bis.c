...
#define IPPC "192.168.1.23" //define the IP of the receiver PC
...
int main(int argc, char **argv){
	...
	si_other.sin_addr.s_addr = inet_addr(IPPC); //specific binding to listenser
	...
	for (int k=0; k < 50 ; k++){
		...
		/*trigger source -- Channel A, positive edge*/ 
